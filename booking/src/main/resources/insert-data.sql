...
VALUES (4.5, 7, true, true, 4, 1, 1, 1, 'Apartment', 'A cozy apartment', 'Cozy Apartment 1', 'Active', 1),
       (4.2, 5, true, false, 2, 1, 2, 2, 'Room', 'Comfortable room with a view', 'Room with a View', 'Active', 2),
...
INSERT INTO review (host_id, accommodation_id, grade, is_approved, author_id, comment, date)
VALUES (1, null, 4, true, 6, 'Great host!','2023-01-05 12:00:00'),
       (2, null, 5, true, 7, 'Excellent hospitality','2023-01-05 12:00:00'),
       (3, null, 4, true, 8, 'Wonderful stay, highly recommend','2023-01-05 12:00:00'),
       (3, null, 3, true, 9, 'Good experience overall','2023-01-05 12:00:00'),
       (4, null, 5, true, 10, 'Perfect host, would come again','2023-01-05 12:00:00'),
       (5, null, 4, true, 6, 'Enjoyed my stay, great host!','2023-01-05 12:00:00'),
       (null, 1, 5, true, 7, 'Beautiful accommodation, highly recommended!','2023-01-05 12:00:00'),
       (null, 2, 4, true, 8, 'Comfortable and clean, would come again','2023-01-05 12:00:00'),
       (null, 3, 3, true, 9, 'Good location but room was a bit small','2023-01-05 12:00:00'),
       (null, 3, 5, true, 10, 'Exceptional service and amenities','2023-01-05 12:00:00'),
       (null, 4, 3, true, 1, 'Average experience, could be better','2023-01-05 12:00:00'),
       (null, 4, 4, true, 2, 'Lovely place with a friendly host','2023-01-05 12:00:00'),
       (null, 5, 5, true, 3, 'Outstanding accommodation, exceeded expectations','2023-01-05 12:00:00'),
       (null, 5, 4, true, 4, 'Great value for money, would recommend','2023-01-05 12:00:00'),
       (2, null, 5, true, 5, 'Fantastic experience, thank you!','2023-01-05 12:00:00'),
       (null, 4, 3, true, 6, 'Not bad, but room was noisy','2023-01-05 12:00:00'),
       (null, 2, 4, true, 7, 'Well-maintained property with good facilities','2023-01-05 12:00:00'),
       (null, 1,5, true, 8, 'Superb hospitality, felt like home','2023-01-05 12:00:00'),
       (null, 1, 3, true, 9, 'Average amenities, but good location','2023-01-05 12:00:00'),
       (3, null, 5, true, 10, 'Absolutely amazing, 10/10','2023-01-05 12:00:00'),
       (4, null, 4, true, 1, 'Friendly staff and comfortable stay','2023-01-05 12:00:00'),
       (null, 5, 5, true, 2, 'Impressive accommodation with a view','2023-01-05 12:00:00'),
       (null, 5, 4, true, 3, 'Clean and well-equipped, enjoyed my stay','2023-01-05 12:00:00'),
       (4, null, 3, true, 4, 'Satisfactory, but could use some improvements','2023-01-05 12:00:00'),
       (1, null, 5, true, 5, 'Incredible experience, highly satisfied','2023-01-05 12:00:00');
